...
const centers = {
  NorthCoastal:  { lat: 33.1216, lng: -117.3150 },
  NorthInland:   { lat: 33.2183, lng: -116.9625 },
  NorthCentral:  { lat: 32.8350, lng: -117.1660 },
  East:          { lat: 32.8200, lng: -116.8650 },
  Central:       { lat: 32.7312, lng: -117.1300 },
  South:         { lat: 32.6200, lng: -117.0800 }
};

const radius = 50000; // ~31 miles for regional coverage
const PER_PAGE = 20;
